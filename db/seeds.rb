...
# Create schedules
schedule1 = Schedule.create(start_time: Time.zone.now, end_time: Time.zone.now + 2.hours, day_of_week: 'Monday', branch: branch1)
schedule2 = Schedule.create(start_time: Time.zone.now, end_time: Time.zone.now + 3.hours, day_of_week: 'Tuesday', user: user2)
