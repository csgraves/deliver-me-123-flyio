  ...
  def create
    ...
    respond_to do |format|
      if @lesson_payment.save
        format.html { redirect_to lesson_payment_url(@lesson_payment), notice: "Lesson payment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @lesson_payment.update(lesson_payment_params)
        format.html { redirect_to lesson_payment_url(@lesson_payment), notice: "Lesson payment was successfully updated." }
